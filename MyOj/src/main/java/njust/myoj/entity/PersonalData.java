    ...
    public void updatePersonalData(TestLibrary testLibrary, History history) {
        if (testLibrary.getSubject() == 1) {
            ...
            if (history.isCorrectness()) {
                this.math_correct++;
                this.setProgresspercentage_ma(this.math_correct * 10000 / 1000);
            }
            ...
            if (history.isCorrectness()) {
                ...
                this.setProgresspercentage_ch(this.chinese_correct * 10000 / 1000);
            }
            ...
            if (history.isCorrectness()) {
                ...
                this.setProgresspercentage_en(this.english_correct * 10000 / 1000);
            }
        ...
        this.setProgresspercentage((this.math_correct + this.chinese_correct + this.english_correct) * 10000 / 3000);
    }
